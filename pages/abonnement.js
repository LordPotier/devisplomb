  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="max-w-sm w-full mx-auto p-8 bg-white rounded-2xl shadow-sm border border-gray-100 text-center">
        ...
        <p className="text-gray-500 text-sm mb-6">Tout inclus, sans engagement</p>
        <div className="text-4xl font-bold text-gray-900 mb-1">29 €<span className="text-lg font-normal text-gray-400">/mois</span></div>
        <p className="text-xs text-gray-400 mb-6">HT · Essai gratuit 14 jours</p>
        ...
        <p className="text-xs text-gray-400 mt-3">Aucune carte requise pour l'essai</p>
      </div>
    </div>
  )
}
